  ...
  return (
    <nav className="border-b-2">
        <div className="max-w-7xl mx-auto flex justify-between items-center py-8">
            ...
            <div className="pl-2 ">
                <a href="#">
                    <img src={logo} alt="sesar" width={150} height={15} />
                </a>
            </div>

            {/* we use @remixicon/react library for icons */}
            ...
            <div className={`${
                isOpen ? "block" : "hidden"} md:hidden absolute bg-neutral-50 w-full py-5 px-4 mt-[362px] border-b-2 text-center`}>
                    {LINKS.map((link, index) => (
